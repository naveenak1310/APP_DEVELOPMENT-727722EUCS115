...
export default function BookingPage() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('/api/bookings/add', bookingDetails)
            .then(response => {
            ...
            .catch(error => {
                ...
                alert('Failed to book the hall. Please try again.');
            });
    };
    ...
    return (
        <div className="booking-page">
            ...
            <div className="hall-details-container">
                ...
                <p><strong>Available Types:</strong> {hall.type.join(', ')}</p>
                <p><strong>Available Times:</strong> {hall.time.join(', ')}</p>
            </div>
