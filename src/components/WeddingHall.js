...
import './Hall.css';
import hallImage from '../hall4.webp'; // Adjust the path as needed
      ...
      <div className="features-section">
        <div className="image-and-details">
          ...
          <div className="hall-details">
            <h3>Exquisite Hall</h3>
            
            <p style={{color:'black'}}>Call us for price : +91 87822133423</p>
          </div>
        </div>
